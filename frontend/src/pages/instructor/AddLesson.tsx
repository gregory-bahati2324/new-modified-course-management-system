...
import { 
  ...
  Award, Sun, Moon, Type, Download, Play, Volume2
} from 'lucide-react';
                        ...
                        return (
                          <Card key={block.id} className="border-2">
                            ...
                            <CardContent>
                              ...
                              {(block.type === 'pdf' || block.type === 'ppt') && (
                                <div className="space-y-2">
                                  <Input
                                    placeholder={`${block.type.toUpperCase()} file URL`}
                                    value={block.content}
                                    onChange={(e) => updateContentBlock(block.id, 'content', e.target.value)}
                                  />
                                  <div className="p-4 border rounded-lg flex items-center gap-2">
                                    ...
                                    <div className="flex-1">
                                      <p className="text-sm font-medium">Downloadable {block.type.toUpperCase()}</p>
